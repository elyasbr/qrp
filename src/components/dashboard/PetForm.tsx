...
//     try {
//       // First, ensure all absolutely required fields have values
//       const requiredDefaults = {
//         typePet: "سگ",
//         phoneNumberVeterinarian: "+982112345678", 
...
//         typePet: String(formData.typePet || "سگ"),
...
//         phoneNumberVeterinarian: String(formData.phoneNumberVeterinarian || "+982112345678"),
...
//         mobile1Head: String(formData.mobile1Head || "+989123456789"),
//         mobile2Head: String(formData.mobile2Head || "+989987654321"),
//         telHead: String(formData.telHead || "+982112345678"),
...
//         whatsAppHead: String(formData.whatsAppHead || "+989123456789"),
...
//         phoneNumberGeneralVeterinarian: String(formData.phoneNumberGeneralVeterinarian || "+982112345678"),
...
//         phoneNumberSpecialistVeterinarian: String(formData.phoneNumberSpecialistVeterinarian || "+982112345678"),
...
//         certificatePDF: String(formData.certificatePDF || "certificate.pdf"),
//         insurancePDF: String(formData.insurancePDF || "insurance.pdf"),
...
//                     <input
//                       type="text"
//                       value={formData.typePet || ""}
//                       onChange={(e) => handleInputChange("typePet", e.target.value)}
//                       className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                       required
//                       placeholder="مثال: سگ، گربه (اجباری)"
//                     />
//                   </div>
...
//                       onChange={(e) => handleInputChange("phoneNumberVeterinarian", e.target.value)}
//                       className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                       required
//                       placeholder="مثال: 02112345678 (اجباری)"
//                     />
//                   </div>
...
//                     onChange={(e) => handleInputChange("mobile1Head", e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                     required
//                     placeholder="مثال: 09123456789 (اجباری)"
//                   />
//                 </div>
...
//                     onChange={(e) => handleInputChange("mobile2Head", e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                   />
//                 </div>
...
//                     onChange={(e) => handleInputChange("telHead", e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                   />
//                 </div>
...
//                     onChange={(e) => handleInputChange("whatsAppHead", e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                   />
//                 </div>
...
//                     onChange={(e) => handleInputChange("phoneNumberGeneralVeterinarian", e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                     required
//                     placeholder="مثال: 02112345678 (اجباری)"
//                   />
...
//                     onChange={(e) => handleInputChange("phoneNumberSpecialistVeterinarian", e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                     required
//                     placeholder="مثال: 02112345678 (اجباری)"
//                   />
...
//                 <div>
//                   <label className="block text-sm font-medium text-gray-700 mb-1">گواهی PDF</label>
//                   <input
//                     type="text"
//                     value={formData.certificatePDF || ""}
//                     onChange={(e) => handleInputChange("certificatePDF", e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                   />
//                 </div>

//                 <div>
//                   <label className="block text-sm font-medium text-gray-700 mb-1">بیمه PDF</label>
//                   <input
//                     type="text"
//                     value={formData.insurancePDF || ""}
//                     onChange={(e) => handleInputChange("insurancePDF", e.target.value)}
//                     className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--main-color)] focus:border-transparent"
//                   />
//                 </div>
...
//                     phoneNumberVeterinarian: "02112345678",
//                     issuingMedicalSystem: "سیستم پزشکی تهران",
//                     nameHead: "احمد احمدی",
//                     nationalCodeHead: "1234567890",
//                     mobile1Head: "09123456789",
//                     mobile2Head: "09987654321",
//                     telHead: "02112345678",
//                     iso3Head: "IRN",
//                     stateHead: "تهران",
//                     cityHead: "تهران",
